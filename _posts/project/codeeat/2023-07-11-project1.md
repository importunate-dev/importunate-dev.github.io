...
![CodeEat](https://github.com/importunate-dev/importunate-dev.github.io/blob/master/img/CodeEat_Poster.webp?raw=true)
...
| 자료                                                                                                   | 설명                                           |
| ------------------------------------------------------------------------------------------------------ | ---------------------------------------------- |
| [코드잇 포스터](https://github.com/importunate-dev/importunate-dev.github.io/blob/master/img/CodeEat_Poster.pdf) | A1 Size의 포스터로 요약한 프로젝트 내용입니다. |
| [코드잇 깃허브](https://github.com/mosmosfromjungle/mosmos)                                            | 실제 코드를 확인할 수 있습니다.                |
| [코드잇 서비스 주소](codeeat.site)                                                                     | 서비스를 체험해볼 수 있습니다.                 |
| [코드잇 발표 PPT](https://github.com/importunate-dev/importunate-dev.github.io/blob/master/img/codeeat_PPT.pdf)  | 프로젝트 최종 발표 당시의 PPT입니다.           |
