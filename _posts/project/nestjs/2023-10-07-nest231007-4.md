...
{ email: 'importunate-dev@naver.com', password: '19940411' } 같이 이메일과 암호가 포함된 body가 있는 요청이 들어온다.
...
![이미지1](https://raw.githubusercontent.com/importunate-dev/importunate-dev.github.io/master/img/project/nestjs/231007/nest231007-4-1.webp)
...
![이미지2](https://raw.githubusercontent.com/importunate-dev/importunate-dev.github.io/master/img/project/nestjs/231007/nest231007-4-2.webp)
...
GET http://localhost:3000/auth?email=importunate-dev@naver.com
```
...
{
    "email": "importunate-dev@gmail.com"
}
```
