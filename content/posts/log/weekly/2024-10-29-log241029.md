...
![1](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log/2024/log241029/1.webp)
설정에서 검색 제외 관련 기능을 검색하고, `**/lib/**` 을 추가했다. 어느 디렉토리에서든, lib의 하위는 검색에서 제외하겠다는 설정이다.

![2](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log/2024/log241029/2.webp)
