...
![1](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log/2024/log241107/1.webp)

이런식으로, 제대로 된 값이 갖춰지면 밑에 올바르다고 뜬다. 저 SEND TO GA를 누르면 실제 보내볼수 있다.

![2](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log/2024/log241107/2.webp)
