...
---
  ...
  - 테이블로 나누는 과정(장문, 그림판주의)
      1. 가장 큰 테이블로 나누기
          ...
          ![1](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log240216/1.webp)
          ...
          ![2](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log240216/2.webp)
          
      2. 가운데 있는 흰색 box도, 밑에 footer도 table로 구성해야한다. box는 사진과 글이 나타날 곳으로 나눌 수 있다. 아래 회색 영역에 있는 footer는 위아래로 padding이 있기 떄문이다.
         
          ![3](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log240216/3.webp)
      ...
      3. 사진은 저 칸을 꽉 채우면 된다. 하지만 아래 글이 나타날 부분은 꽤나 복잡하다. 가운데 나열하는 요소까지 생각하면 7곳에 글자가 구분되서 나타난다. 위아래 패딩을 생각하면 꽤 많은 행을 가진 테이블이 생성되야 한다. 열은 3개면 충분하다. 좌우패딩만 있으면 되니까.
          ...
          ![4](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log240216/4.webp)
