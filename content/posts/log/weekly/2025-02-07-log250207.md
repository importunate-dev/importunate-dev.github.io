...
![1](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log/2025/02/07/1.webp)

우선 SQS의 트러기 람다 함수는 129번이 호출되었다… 메시지 2개가 다 실패했어도 최대 6번이었어야 했다.

![2](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log/2025/02/07/2.webp)

Step Functions 상태머신은 감동실화로 총 900번이상 호출되었다…

![3](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log/2025/02/07/3.webp)
...
![4](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log/2025/02/07/4.webp)
...
![5](https://cdn.jsdelivr.net/gh/importunate-dev/blog-images/log/2025/02/07/5.webp)
...
- [웹훅 설계·운영 기록 허브](/portfolio/webhooks/)
- [대표 웹훅 케이스 스터디](/posts/2025-07-28-log250728/)
